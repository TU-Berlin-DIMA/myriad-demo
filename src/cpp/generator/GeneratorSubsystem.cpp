...
#include "generator/UserConnectionsGenerator.h"
...
{
	// register with the autorelease pool
	_generatorPool.set(new GraphGen::UserGenerator("user", _config, _notificationCenter));
	_generatorPool.set(new GraphGen::UserConnectionsGenerator("user_connections", _config, _notificationCenter));
}
